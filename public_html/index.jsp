	...
	<div id="site_content">		
	  ...
	  <div id="content">
        <div class="content_item">
          ...
          <p>Put in your lucky and unlucky number, then let Powerball choose your fate...</p>   				  
	  ...
	  <div class="container">
	    ...
	    <div class="testimonials">
	      <h3>Number Choice</h3>
		  <form action="/java112/PowerballServlet" method="get">
			Your Lucky Number: <input type="text" name="yourLuckyNumber"><br>
			Your UN-Lucky Number: <input type="text" name="yourUnluckyNumber"><br>
